...
def sendMsg():
    ...
    message_type = 'nsp.app.cloudprint'
    uid = 1130703
    cid = '00d41d8cd98f00b204e9800942245894'
    files = list()
    name = '小说.txt'
    ...
    files.append(f3)
    '''
    ret = svc.send(message_type, {'nsp.event.uid' : uid, 'nsp.event.cid' : cid, 'action' : 'print', 'files' : files})
    print ret
